 ...
 * analyze by producing various stats are provided. Highly customizable by changing parameters.
 */
...
public class randomAnalyze
{
	...
	public double findRatio(Graph graph)
	{
	  ...
	  /** Edge Ratios found earlier are returned
	   @return graph	[]	 Array containing the ratios
	   */
